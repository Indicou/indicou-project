  ...
  <div class="log tudo">
    <div class="login-form"><router-link class="btn-voltar" to="/home" style="text-align: left; margin-top: 10px; padding-left: 10px;">
      ...
      >
        ...
        <div class="txtb" style="margin: 25px 0px 25px 0px" :class="{mudatamanho: senhaerrada}">
          <input type="password"
        ...
        <div style="text-align:center; padding:25px; font-size: 17px; font-family: 'Poppins', sans-serif;">
          Ou acesse
        </div>
        ...
        <button disabled @click="Facebook()" class="btn btn-lg btn-facebook btn-block cinza" style="border-radius: 25px; font-size: 15px; height: 45px; font-family: 'Poppins', sans-serif;" type="buttom"><i class="fab fa-facebook-f mr-2" style="margin-right: 10px;"></i> Entrar via Facebook</button>
        <div class="bottom-text" style="font-size: 15px; font-family: 'Poppins', sans-serif;">
          Esqueceu sua senha?
          <router-link to="/forgetpassword" style="font-family: 'Poppins', sans-serif;color:#34db7f">Clique aqui</router-link>
        </div>
        <div class="bottom-text" style="font-size: 15px; font-family: 'Poppins', sans-serif;">
